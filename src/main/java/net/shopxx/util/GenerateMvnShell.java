...
/**
 * 本工具目的是将非mvn项目转换成maven管理项目
 * 使用方法，将jar包放入对应路径，生成call mvn的Windows批处理命令，放入Windows中执行
 * 第二步，将生成pom的引用dependency脚本复制入
 * @author Daniel
 *
 */
...
//						System.out.println(cmd);
	...
	public static void main(String[] args) {
		String path = "C:/Users/Daniel/Downloads/shopxx-3.0RELEASE/WebContent/WEB-INF/lib";// jar包的存放路径
		ListFile(path);
	}
